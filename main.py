...
# --- [V3] CORE: INTELIGÊNCIA E MÉTRICAS GLOBAIS ---
...
async def api_ml():
    try:
        ...
        # Processamento de Datas (Governança: Formato Brasil)
        ...
        # --- VISÃO ATÔMICA: EXPLOSÃO DE ITENS ---
        ...
        # Distribuição Proporcional: Evita inflar o faturamento no ranking individual
        ...
        # Ranking de Produtos (Top 10 Global)
